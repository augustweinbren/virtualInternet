...
public class TaptoPlace : MonoBehaviour
{
    ...
    //the Prefab GameObject to instantiate in the AR environment. To be added in the inspector window
    ...
    void Update() {
        ...
        {
            var hitPose = hits[0].pose; // not used
            if (timeThreshold < 0)
            {
                ...
                // {
                    spawnedObject = Instantiate(gameObjectToInstantiate, new Vector3(
                        ...
                        Camera.main.transform.position.z + 1f), gameObjectToInstantiate.transform.rotation);
                // }
                // else
                // {
